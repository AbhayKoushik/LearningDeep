...
# Training the SOM using Minimalistic implementation of Self Organizing Maps
from minisom import MiniSom
som=MiniSom(x=10, y=10,input_len=15,sigma=1.0, learning_rate=0.5)  # 10 X 10 feature map
...
frauds=np.concatenate((mappings[(5,3)], mappings[(8,3)]),axis=0)  # Getting out-lying winning nodes
